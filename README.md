...
The Empathy Engine dynamically adjusts **pitch**, **rate**, and **volume** based on detected emotional context.

Below are real outputs generated by the system:

---

### 🎙️ Normal Voice (Baseline)
Standard TTS output without emotional modulation.

<audio controls>
  <source src="docs/media/voice1_normal.wav" type="audio/wav">
</audio>

👉 [Download Audio](./docs/media/voice1_normal.wav)

---

### 🎭 Emotional Voice (Offline Model)
Emotion-aware speech using rule-based modulation (VADER + pyttsx3).

<audio controls>
  <source src="docs/media/voice2_offline_emotional_improved.wav" type="audio/wav">
</audio>

👉 [Download Audio](./docs/media/voice2_offline_emotional_improved.wav)

---

### 🧠 Emotional Voice (HuggingFace Model)
Advanced emotion detection using transformer-based model.

<audio controls>
  <source src="docs/media/voice3_huggingface_based_model.wav" type="audio/wav">
</audio>

👉 [Download Audio](./docs/media/voice3_huggingface_based_model.wav)

---

> 🎯 Notice how tone, speed, and expressiveness improve from baseline → offline → transformer-based model.
## Overview
